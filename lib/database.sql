...
CREATE TABLE IF NOT EXISTS hindu_sammelan (
    ...
    total_contacted_mandals INTEGER,
    total_contacted_villages INTEGER,
    total_basti INTEGER,
    total_contacted_basti INTEGER,
    other_info TEXT,
    total_distributed_forms INTEGER,
    total_distributed_stickers INTEGER,
    total_book_sales INTEGER,
    total_participating_teams INTEGER,
    total_participating_workers INTEGER,
    male_workers INTEGER,
    female_workers INTEGER,
    yoga_workers INTEGER,
    special_person_contacts INTEGER,
    total_houses INTEGER,
    total_contacted_houses INTEGER,
    swayamsevak_houses INTEGER,
    supporter_houses INTEGER,
    neutral_houses INTEGER,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
