...
export default function HinduEventsPage() {
  ...
  // Submenu items
  const submenuItems = [
    { id: 1, name: 'विजयादशमी उत्सव', href: '#' },
    { id: 2, name: 'व्यापक गृह संपर्क अभियान', href: '/vayapak-grh-sampark' },
    { id: 3, name: 'प्रमुखजन गोष्ठी', href: '#' },
    { id: 4, name: 'सद्भाव बैठक', href: '#' },
    { id: 5, name: 'बाल शिविर', href: '#' },
    ...
    <div className="p-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200/50 p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">शताब्दी वृत्त संकलन</h1>
